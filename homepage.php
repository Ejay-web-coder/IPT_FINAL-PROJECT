...
<img
      src="image/193b33e5-8839-46b6-98e2-d56d3877a21c_removalai_preview.png"
      class="seal"
      width="80"
      height="80"
    />
  ...
  <main class="container d-flex flex-column flex-md-row align-items-center align-items-md-start justify-content-between gap-4 px-4 px-md-5">
    ...
    <section>
      <img alt="Illustration of hands holding a tablet showing a job offer document with a magnifying glass highlighting the text 'JOB OFFER', surrounded by papers and an envelope" class="img-fluid" height="280" src="https://storage.googleapis.com/a1aa/image/933f8471-4c1e-4e78-e7d9-ced44b8fdeec.jpg" width="400" />
    </section>
  </main>
</body>
</html>